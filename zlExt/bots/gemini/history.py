...
def appendUserMessage(id, content, limit=20):
    msg = {"role": "user", "content": content}
    return appendMessage(id, msg, False, limit)

def appendModelMessage(id, content, limit=20):
    msg = {"role": "model", "content": content}
    return appendMessage(id, msg, False, limit)

def appendGroupUserMessage(id, content, limit=20):
    msg = {"role": "user", "content": content}
    return appendMessage(id, msg, True, limit)

def appendGroupModelMessage(id, content, limit=20):
    msg = {"role": "model", "content": content}
    return appendMessage(id, msg, True, limit)
